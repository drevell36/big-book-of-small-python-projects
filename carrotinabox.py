...
print(
    """Carrot in a Box,
      ...
      This is a bluffing game for two human players. Each player has a box. One box has a carrot in it. To win, you have the box with the carrot in it.
      
      This is a very simple and silly game.
      
      The first player looks into their box (the second player must close their eyes during this). The first player then says "There is a carrot in my box" or "There is not a carrot in my box".  The second player then gets to decide if they to swap boxes or not."""
)
...
print("\n" * 100)  # Clear the screen by printing several new lines.
...
print("  1) There is not a carrot in my box.")
print()
input("Then press Enter to continue...")
...
input("Press Enter to to reveal the winner...")
print()
...
# This modification made possible through 'carrotInFirstBox' variable
if carrotInFirstBox:
