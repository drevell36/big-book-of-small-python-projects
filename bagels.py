...
# Set number of digits in (tuple)
NUM_DIGITS = 3
# Set number of max guesses allowed (tuple)
MAX_GUESSES = 10
...
For example, if the secret number was 248 and your guess would be Fermi Pico.""".format(
            NUM_DIGITS  # List number of digits in {}
        )
    )

    while True:  # Main game loop
        # This stores the number the player needs to guess:
        secretNum = getSecretNum()
        print("I have thought up a number.")
        # List number of digits in {}
