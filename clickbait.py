...
def main():
    ...
    website = random.choice(
        ["wobsite", "blag", "Facebuuk", "Google", "Facesbook", "Tweedie", "Pastagram"]
    )
...
def generateReasonsWhyHeadline():
    ...
    return "{} Reasons Why {} Are More Interesting Than You Think (Number {} Will Surprise You!)".format(
        number1, pluralNoun, number2
    )
...
def generateJobAutomatedHeadline():
    ...
    if pronoun1 == "Their":
        return (
            "This {} {} Didn't Think Robots Would Take {} Job. {} Were Wrong.".format(
                state, noun, pronoun1, pronoun2
            )
        )
    else:
        return "This {} {} Didn't Think Robots Would Take {} Job. {} Was Wrong.".format(
            state, noun, pronoun1, pronoun2
        )
