...
def main():
    print(
        """Blackjack
          ...
          Rules:
            ...
            but must hit exactly one more before standing.
    ...
    while True:  # Main game loop
        ...
        # Let the enter their bet for this round:
        print("Money:", money)
        bet = getBet(money)
...
def getBet(maxBet):
    """Ask the player how much they to bet for this round."""
...
def getMove(playerHand, money):
    ...
    while True:  # Keep looping until the player enters a correct move.
        ...
        # The player can double down on their first move, which we tell because they'll have exactly two cards:
